...
- {id: CAN_CLK_ROOT.outFreq, value: 24 MHz}
...
- {id: SAI1_CLK_ROOT.outFreq, value: 4.2336 MHz}
- {id: SAI1_MCLK1.outFreq, value: 4.2336 MHz}
- {id: SAI1_MCLK2.outFreq, value: 4.2336 MHz}
...
- {id: USDHC1_CLK_ROOT.outFreq, value: 2376/29 MHz}
- {id: USDHC2_CLK_ROOT.outFreq, value: 2376/29 MHz}
settings:
...
- {id: CCM.SAI1_CLK_PODF.scale, value: '54', locked: true}
- {id: CCM.SAI1_CLK_PRED.scale, value: '4', locked: true}
...
- {id: CCM.USDHC1_PODF.scale, value: '4', locked: true}
...
- {id: CCM_ANALOG.PLL4.div, value: '38', locked: true}
- {id: CCM_ANALOG.PLL4.num, value: '64', locked: true}
...
const clock_audio_pll_config_t audioPllConfig_BOARD_BootClockRUN =
    {
        .loopDivider = 38,                        /* PLL loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
        .postDivider = 1,                         /* Divider after PLL */
        .numerator = 64,                          /* 30 bit numerator of fractional loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set USDHC1_PODF. */
    CLOCK_SetDiv(kCLOCK_Usdhc1Div, 3);
    ...
    /* Set SAI1_CLK_PODF. */
    CLOCK_SetDiv(kCLOCK_Sai1Div, 53);
    ...
    CCM_ANALOG->PLL_AUDIO_NUM = CCM_ANALOG_PLL_AUDIO_NUM_A(64);
    ...
    pllAudio = (CCM_ANALOG->PLL_AUDIO & (~(CCM_ANALOG_PLL_AUDIO_DIV_SELECT_MASK | CCM_ANALOG_PLL_AUDIO_POWERDOWN_MASK))) |
               CCM_ANALOG_PLL_AUDIO_ENABLE_MASK | CCM_ANALOG_PLL_AUDIO_DIV_SELECT(38);
    ...
    /* DeInit Usb2 PLL. */
    CLOCK_DeinitUsb2Pll();
    /* Enable Usb2 PLL output for USBPHY2. */
