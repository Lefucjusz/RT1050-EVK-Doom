 ...
 */
#define USB_HOST_CONFIG_MAX_PIPES (USB_HOST_CONFIG_HUB_MAX_PIPES + 1U * USB_HOST_CONFIG_INTERFACE_MAX_EP)
 ...
 */
#define USB_HOST_CONFIG_EHCI_MAX_SITD (0U * USB_HOST_CONFIG_INTERFACE_MAX_EP)
 ...
 * @remarks Depends on the total number of device interfaces that can have isochronous endpoints.
 */
#define USB_HOST_CONFIG_OHCI_MAX_ITD (0U * USB_HOST_CONFIG_INTERFACE_MAX_EP)
